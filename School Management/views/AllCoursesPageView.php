...
<section id="about" class="section-content about">
        <div class="container">
        	<div class="row">
			  ...
			  echo '<img  title="Roland Maruntelu" alt="your photo" src="'.$url.'" width="300px"height="300px"  />'; //to show img 
				...
				<a href="StudentPageView.php" type="submit" class="btn btn-primary btn-lg btn3d" name="submit"><span class="glyphicon glyphicon-cloud"></span> Go Home</a>
		...
		<br/>
		<br/>
		<h2 style="color:blue" class="slogan">All Courses  <span class="glyphicon glyphicon-folder-open"></span></h2>
              ...
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-12">
                    <h3 class="panel-title"><span class="glyphicon glyphicon-th"></span>All Courses</h3>
                  </div>
                ...
                <table class="table table-striped table-bordered table-list">
				  ...
				  <?php
                   ...
                   if($_SESSION['username'])
				   {
						...
						echo "<p style='color:red;font-weight:bold;'>the number of courses the admin accepted them are ".$count1." the max is 6 </p>";

						$courses_rows = $student->displayunregisteredcourses($id);
                        ...
                        echo " <tbody> <tr>
							...
							<td align='center'>
								<form action='../controller/Register_C_Controller.php' method='post'>
									<input type='hidden' name='select' value='yes'>
									<input type='hidden' name='course_id' value='{$courses_rows[$i]['id']}'>

									<button type='submit' class='btn btn-default'><em class='fa fa-pencil'></em>request Course</button></form>
							</td>
